...
This proposal has been carried forward into the shipped runtime spec at [`docs/specs/CONTEXTUAL-SECURITY-UPLIFT-SPEC.md`](/mnt/s/Development/GuardianAgent/docs/specs/CONTEXTUAL-SECURITY-UPLIFT-SPEC.md). It remains here as design rationale and historical context.
