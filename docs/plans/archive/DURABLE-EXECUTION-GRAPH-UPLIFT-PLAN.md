...
**Archived:** 2026-04-29
**Archive reason:** Completed for the scoped durable execution graph architecture plan. Follow-on quality, connector stress, long-running run UX, and coding workspace observability work now lives in `docs/plans/POST-GRAPH-QUALITY-AND-CODING-WORKSPACE-UPLIFT-PLAN.md`.
