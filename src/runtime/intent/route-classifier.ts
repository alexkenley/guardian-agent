...
const INTENT_GATEWAY_COMPACT_INSTRUCTION_LINES = [
  ...
  'Example: "Create a GuardianAgent GitHub issue for the last bad response." -> route=diagnostics_task, operation=draft, toolName=guardian_issue_draft.',
  'Example: "Draft a GuardianAgent problem report from diagnostics for the latest completed assistant request. Do not create a GitHub issue." -> route=diagnostics_task, operation=draft, toolName=guardian_issue_draft.',
  'Example: prior assistant just drafted a GuardianAgent diagnostics issue and the user says "Submit this GitHub issue." -> route=diagnostics_task, turnRelation=follow_up, operation=send, toolName=github_issue_create.',
...
const INTENT_GATEWAY_JSON_FALLBACK_SYSTEM_PROMPT = [
  ...
  'Examples: "Create a GuardianAgent GitHub issue for the last bad response." -> route="diagnostics_task", operation="draft", toolName="guardian_issue_draft", executionClass="tool_orchestration", preferredTier="external", requiresRepoGrounding=false, requiresToolSynthesis=true, expectedContextPressure="medium", preferredAnswerPath="tool_loop".',
  'Examples: "Draft a GuardianAgent problem report from diagnostics for the latest completed assistant request. Do not create a GitHub issue or post externally." -> route="diagnostics_task", operation="draft", toolName="guardian_issue_draft", executionClass="tool_orchestration", preferredTier="external", requiresRepoGrounding=false, requiresToolSynthesis=true, expectedContextPressure="medium", preferredAnswerPath="tool_loop".',
  'Examples: prior assistant just drafted a GuardianAgent diagnostics issue and the user says "Submit this GitHub issue." -> route="diagnostics_task", turnRelation="follow_up", operation="send", toolName="github_issue_create", executionClass="tool_orchestration", preferredTier="external", requiresRepoGrounding=false, requiresToolSynthesis=true, expectedContextPressure="medium", preferredAnswerPath="tool_loop".',
...
const INTENT_GATEWAY_ROUTE_ONLY_FALLBACK_SYSTEM_PROMPT = [
  ...
  'Example: "Create a GuardianAgent GitHub issue for the last bad response." -> route="diagnostics_task", operation="draft".',
  'Example: "Draft a GuardianAgent problem report from diagnostics for the latest completed assistant request. Do not create a GitHub issue." -> route="diagnostics_task", operation="draft".',
  'Example: prior assistant just drafted a GuardianAgent diagnostics issue and the user says "Submit this GitHub issue." -> route="diagnostics_task", operation="send", toolName="github_issue_create".',
