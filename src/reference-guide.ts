            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'Chat source badges describe the final provider that generated the answer. When available, the badge also shows the provider name, and the tooltip explains when a requested local or external route ended up returning from the opposite side.',
                ],
                note: 'Web chat now uses SSE-backed live run updates. The pending assistant reply shows structural progress such as planning, tool use, approval waits, and completion without exposing raw prompts or scratchpads.',
              },
            ],
          },
          {
            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'The Code chat tab now shows a compact live progress strip while a coding turn is still running, and the `Activity` view shows the fuller session-scoped run timeline with tool steps, approval pauses, and verification milestones.',
                  'Completed assistant replies in Code also show the final response-source badge, including the actual local or external side and provider name when that metadata is available.',
