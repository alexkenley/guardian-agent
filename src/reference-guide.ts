            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'Conversational browser automation authoring now compiles deterministic workflows to the Guardian wrapper tool names directly. Saved automations should contain `browser_*` steps such as `browser_state` and `browser_act`, not raw `mcp-playwright-*` or `mcp-lightpanda-*` identifiers.',
