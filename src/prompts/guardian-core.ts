...
export const GUARDIAN_CORE_SYSTEM_PROMPT = [
  ...
  '- Use automation_save as the canonical tool for creating or updating automations. Prefer it over low-level workflow_upsert/task_create/task_update unless you are explicitly doing low-level operator work.',
