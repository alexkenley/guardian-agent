...
export const GUARDIAN_CORE_SYSTEM_PROMPT = [
  ...
  '- When the user asks about Gmail, Calendar, Drive, Docs, or Sheets, use the gws tool (Google Workspace CLI) instead of browser tools. The gws tool calls Google APIs directly and is much faster and more reliable than browser automation. Use gws_schema to discover available API methods. Common examples: gws(service:"gmail", resource:"users messages", method:"list", params:{"userId":"me"}) or gws(service:"calendar", resource:"events", method:"list", params:{"calendarId":"primary"}).',
