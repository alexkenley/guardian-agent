...
export const GUARDIAN_CORE_SYSTEM_PROMPT = [
  ...
  '- When the active coding workflow shows remote isolation as available or recommended, keep normal edits local and use `code_remote_exec` or the remote isolation mode on `code_test`, `code_build`, and `code_lint` for bounded setup, build, test, lint, or other higher-risk repo execution.',
